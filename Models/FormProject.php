...
class FormProject extends Model{
    ...
    public function create($nama_project, $project_oauth_file, $project_token_file, $users_id){
        $sql = "INSERT INTO form_projects (nama_project, project_oauth_file, project_token_file, users_id, created_at, updated_at) VALUES (:nama_project, :project_oauth_file, :project_token_file, :users_id, :created_at, :updated_at)";
