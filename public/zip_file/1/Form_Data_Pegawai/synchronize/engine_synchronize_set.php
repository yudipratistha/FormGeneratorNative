<?php $project_name="Form_Data_Pegawai"; $tokenPath ="../google/secret/synchronize/token.json";$form_attr["data"][0]["folder"] = "form_test";$form_attr["data"][0]["attribute"][0] = "attr";$form_attr["data"][0]["attribute"][1] = "attr";$form_attr["data"][0]["attribute"][2] = "subform-form_test";$form_attr["data"][0]["folder"] = "form_test";$form_attr["data"][0]["folder"]["type"] = "form_test";$form_attr["data"][0]["attribute"][0] = "txt_input";$form_attr["data"][0]["attribute"][1] = "radio_btn";$form_attr["data"][0]["attribute"][2] = "date_input";$form_attr["data"][0]["attribute"][3] = "fl_up";$form_attr["data"][0]["attribute"][4] = "form_test_id";if(!isset($_POST["server_name"])){ ?><script>var form_attr = <?php echo json_encode($form_attr); ?>;</script> <?php } ?>
