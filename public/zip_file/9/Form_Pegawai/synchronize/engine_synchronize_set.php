<?php $project_name="Form_Pegawai"; $tokenPath ="../google/secret/synchronize/token.json";$form_attr["data"][0]["folder"] = "testt";$form_attr["data"][0]["attribute"][0] = "uginm";$form_attr["data"][0]["attribute"][1] = "attr";if(!isset($_POST["server_name"])){ ?><script>var form_attr = <?php echo json_encode($form_attr); ?>;</script> <?php } ?>
