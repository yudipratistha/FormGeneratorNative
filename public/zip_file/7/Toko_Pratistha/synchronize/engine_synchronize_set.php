<?php $project_name="Toko_Pratistha"; $tokenPath ="../google/secret/synchronize/token.json";$form_attr["data"][0]["folder"] = "master_data_barang";$form_attr["data"][0]["attribute"][0] = "nama_barang";$form_attr["data"][0]["attribute"][1] = "stok_barang";$form_attr["data"][0]["attribute"][2] = "jenis_barang";$form_attr["data"][0]["attribute"][3] = "foto_barang";if(!isset($_POST["server_name"])){ ?><script>var form_attr = <?php echo json_encode($form_attr); ?>;</script> <?php } ?>
