...
class formsController extends Controller{
    ...
    public function createPhpSubmit($request){      
        ...
        $php = $php.    '        if (!file_exists(\'google/tmp\')){';
        $php = $php.    '            mkdir(\'google/tmp\', 0777, true);';
        $php = $php.    '        }';
        $php = $php.    '        if (!file_exists(\'google/tmp/attachment\')){';
        $php = $php.    '            mkdir(\'google/tmp/attachment\', 0777, true);';
        $php = $php.    '        }';
        ...
        $php = $php.    '            $new_value = array(';
        $php = $php.    '                $file_keys[$j] => $file_name';
        $php = $php.    '            );';
        ...
        $php = $php.    '                $attr = array(';
        $php = $php.    '                    $_SESSION["display_name_key"] => $_SESSION["display_name"]';
        $php = $php.    '                );';
        ...
        $php = $php.    '            }';
        $php = $php.    '            $attr = array(';
        $php = $php.    '                $primary_column => $lastInsertId';
        $php = $php.    '            );';
        $php = $php.    '            $row = $row + $attr;';
        ...
        $php = $php.    '                }';
        $php = $php.    '                if ($is_value){';
        $php = $php.    '                    if (is_array($value)) $attr = array(';
        $php = $php.    '                            $labels[$keys[$i]] => implode(", ", $value)';
        $php = $php.    '                    );';
        $php = $php.    '                    else $attr = array(';
        $php = $php.    '                        $labels[$keys[$i]] => $value';
        $php = $php.    '                    );';
        $php = $php.    '                    $row = $row + $attr;';
        $php = $php.    '                }';
        $php = $php.    '                $i++;';
